...
class Canvas:
    def __init__(self, width, height, bg_color, header_height):
        ...
        # Define track waypoints using cell coordinates
        cell_waypoints = [
        ...
        # Initialize the train with pixel coordinates as waypoints
        self.train = Train(CELL_SIZE * 1.5, CELL_SIZE * 1.5, TRAIN_COLOR, SPEED, self.waypoints)
    ...
    def draw(self, screen):
        ...
        self.track.draw_track(canvas_area)  # Draw the track on the canvas
