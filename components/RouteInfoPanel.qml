...
Rectangle {
    ...
    Dialog {
        ...
        title: "⚠️ Emergency Stop All Routes"
        modal: true
        anchors.centerIn: parent
        ...
        Column {
            ...
            Text {
                width: parent.width
                text: "⚠️ This action cannot be undone and should only be used in emergency situations."
                font.pixelSize: 12
                color: "#d69e2e"
                wrapMode: Text.Wrap
                font.italic: true
    ...
    function confirmEmergencyRelease(routeId) {
        ...
        console.log("⚠️ Emergency release requested for route:", routeId)
